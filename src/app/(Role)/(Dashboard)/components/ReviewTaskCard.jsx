...
export default function ReviewTaskCard({ taskName = 'active'
  , tasks, session, inReview = false, isLoading,badge }) {
        ...
        <Suspense
          ...
          ` :
            ...
            {isLoading ? (
              ...
              <TaskCard
                badge={badge}
                musicTemplate={tasks?.title}
                inReview={inReview}
                title={tasks?.songGenre}
                session={session}
                des={tasks?.jokes}
                plan={tasks?.plan}
                songGenre={tasks?.songGenre}
                item={tasks}
                assignedAtTime={tasks?.dueDate}
